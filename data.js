/*var name = 'Yukti'
var sal = 5500
//to eliminate concatination use string literal "${}""
console.log("employee name:" + name + " and employee salary + sal")
console.log(`employee name: ${name} and employee salary: ${sal}`) */

let employees = [{ "id": 1, "name": "Henrieta", "email": "hcrinidge0@mac.com", "gender": "Female" },
